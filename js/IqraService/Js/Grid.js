    ...
    var printService = new function () {
        ...
        function getFilter(model,list) {
            ...
            if (typeof (model.Printable.filter) === typeof (nope)) {
                //console.log(['getFilter => model, list =>', model, list]);
        ...
        function getSummary(model, list) {
            ...
            list.each(function (i) {
                ...
                if (typeof (model.SummaryData[this.field]) != typeof (none)) {
                    ...
                    //this.onprint = this.onprint || this.created;
                    if (this.onprint) {
                        header += elm = this.onprint.call(model.SummaryData, this, value, elm, i, width);
                    } else if (this.created) {
                        header += elm = this.created(elm);
                    } else {
                        header +=  elm;
                    }
                }
        ...
        function setPeriodic(model, mywindow) {
            ...
            if (model.page && model.page.filter && model.page.filter.length) {
                ...
                if (model.Printable.periodic && periodic.model && periodic.model.field) {
                    ...
                    console.log(['fltr', fltr, model.page.filter, periodic.model.field]);
                } else {
                    fltr = model.page.filter.where('itm=>itm.printable !== false');
                    console.log(['fltr', fltr, model.page.filter, model.Printable.periodic && periodic.model && periodic.model.field]);
                }
