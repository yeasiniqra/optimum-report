...
var Controller = new function (none) {
    ...
    this.Show = function (model) {
        ...
        if (model.istabonly) {
            ...
            windowModel.Show();
            service.Tab.Bind();
            callerOptions.onopen && callerOptions.onopen(windowModel);
        } else {
    ...
    (function () {
        ...
        this.Set = () => {
            if (windowModel) {
                ...
                var container;
                if (typeof callerOptions.container === 'function') {
                    container = callerOptions.container(callerOptions);
                } else if (typeof callerOptions.container === 'string') {
                    container = $(callerOptions.container);
                } else {
                    container = callerOptions.container || $('.tab_container');
                }
                windowModel = { View: container };
                container.append(`<div id="content_container">
