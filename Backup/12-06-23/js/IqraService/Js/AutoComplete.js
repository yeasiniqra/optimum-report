(function (that, nope, none) {
    ...
    function onSetValue(options, value) {
        console.log(['onSetValue(options, value)', options, value]);
        var model;
        ...
        if (model) {
            ...
            options.elm.val(options.selectedvalue = value);
            self.Load(options, true, function () {
                options.page.filter = options.page.filter.where('itm=>itm.field !="' + options.valuefield + '"');
        ...
        this.Bind = function (options) {
            ...
            if (options.elm.data('dropdown')) {
                ...
                options.val = function (value) {
                    ...
                    console.log(['options.val', options, value]);
